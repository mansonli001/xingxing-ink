...
> ⚠️ **本 README 是"项目说明书"**——既是给路人看的，也是给未来的我自己防遗忘用的。  
> 设计/架构/人设/版本史一站到底。下次想动手前，先翻这一份。
...
| **当前版本** | **v0.7.12.1**（2026-05-15）· BP 拦截改触发姐姐主动追问 + 强出 BP 加水印 |
...
| 档位 | 适用心态 | 风格关键词 | 配色 |
|---|---|---|---|
| **🌿 随便聊** | 想法刚冒头 · 想被温柔看一眼 | 像姐姐看你长大 · 温和直率 · 留情面但不留幻觉 | 玫瑰金（暖橙系） |
| **❄️ 讲道理** | 想被认真审视 · 拆假设给路径 | 像咨询顾问 · 结构化 · 最低验证路径 | 银白冷灰 |
| **🔥 扇巴掌** | 已经自我感动 · 需要立刻清醒 | 像被你老板附体 · 反问轰炸 · 通俗类比 · 金句斩首 | 暗红血色 |
